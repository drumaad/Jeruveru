...
// НСК для двох чисел
long NSK_2(long a, long b) { // щоб не робити NSK великою 
 // перевірка на два числа
